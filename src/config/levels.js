...
export const LEVEL_1 = {
  ...
  cops: [
    { x: 400, y: H - 60, minX: 300, maxX: W - 40 },
  ],
  lamps: [
...
export const LEVEL_2 = {
  ...
  cops: [
    { x: 510, y: L2_H - 32, minX: 110, maxX: 770 },
    { x: 300, y: L2_H - 500, minX: 100, maxX: 500 },
    { x: 450, y: L2_H - 750, minX: 250, maxX: 650 },
  ],
  lamps: [
...
export const LEVEL_3 = {
  ...
  platforms: [
    ...
    { x: 100, y: H - 340, w: 260 },
    { x: 700, y: H - 160, w: 200 },
    { x: 1000, y: H - 230, w: 200 },
    { x: 700, y: H - 330, w: 200 },
    { x: 1020, y: H - 450, w: 240 },
    { x: 1060, y: H - 350, w: 180 },
  ],
  ground: [
    { x: 0, y: H - 32, w: W },
  ],
  ladders: [
    { x: 100, topY: H - 180, bottomY: H - 32, minX: 0, maxX: 200 },
    { x: 440, topY: H - 340, bottomY: H - 180, minX: 280, maxX: 540 },
    { x: 800, topY: H - 160, bottomY: H - 32, minX: 700, maxX: 900 },
    { x: 760, topY: H - 330, bottomY: H - 160, minX: 700, maxX: 900 },
    { x: 1140, topY: H - 350, bottomY: H - 230, minX: 1000, maxX: 1240 },
  ],
  shadows: [
    { x: 20, y: H - 150, w: 80, h: 120 },
    { x: 660, y: H - 130, w: 70, h: 100 },
  ],
  fillWalls: [
    { x: 0, y: H - 148, w: 200, h: 116 },
    { x: 370, y: H - 148, w: 170, h: 116 },
    { x: 100, y: H - 308, w: 260, h: 128 },
    { x: 700, y: H - 128, w: 200, h: 96 },
    { x: 1000, y: H - 198, w: 200, h: 166 },
    { x: 700, y: H - 298, w: 200, h: 138 },
    { x: 1020, y: H - 418, w: 240, h: 88 },
    { x: 1060, y: H - 318, w: 180, h: 88 },
  ],
  paintCans: [
  ],
  paintSpots: [
    { x: 290, y: H - 430, w: 130, h: 160, paintingKey: 'painting_heart' },
    { x: 1140, y: H - 550, w: 130, h: 160, paintingKey: 'painting_star' },
  ],
  trashCans: [
    { x: 150, y: H - 204 },
    { x: 830, y: H - 354 },
  ...
  cops: [
    { x: 500, y: H - 32, minX: 250, maxX: 680 },
  ],
  lamps: [
    { x: 130, y: H - 340, radius: 100 },
    { x: 1140, y: H - 442, radius: 110 },
    { x: 500, y: H - 23, radius: 130, intensity: 0.5 },
  ],
  papers: [
    { x: 940, y: H - 25 },
  ],
